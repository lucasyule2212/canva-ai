  ...
  return (
    <div>
      <section className='sm:flex-center hidden h-72 flex-col gap-4 rounded-[20px] border bg-banner bg-cover bg-no-repeat p-10 shadow-inner'>
        <h1 className='h1-semibold max-w-[500px] flex-wrap text-center text-white shadow-sm'>Unleash Your Creative Vision with Canva AI</h1>
      ...
      <section className="sm:mt-12">
        <Collection images={images?.data} page={page} totalPages={images?.totalPage} hasSearch />
      </section>
    </div>
  )
}
